...
SuperCluster.prototype = {
    ...
    getClusters: function (bbox, zoom) {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            var point = c.numPoints ? getClusterJSON(c) : this.points[c.id];
            clusters.push(point);
        }
        return clusters;
    },
        ...
        for (var i = 0; i < points.length; i++) {
            ...
            for (var j = 0; j < neighborIds.length; j++) {
                ...
                if (zoom < b.zoom) {
                    ...
                    b.parentId = i;
                    items.push(points[neighborIds[j]].data[0]);
                    if (this.options.reduce) {
            ...
            if (numPoints === 1) {
                ...
                p.parentId = i;
                clusters.push(createCluster(wx / numPoints, wy / numPoints, numPoints, i, clusterProperties, items));
            }
        }
...
function createCluster(x, y, numPoints, id, properties, items) {
    return {
