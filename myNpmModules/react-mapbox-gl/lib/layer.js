...
var Layer = (function (_super) {
    ...
    function Layer() {
        ...
        _this.isHoverDraggable = function (children) { return (!!_this.hover.map(function (id) { return children[id] ? children[id].props.draggable : false; }).filter(Boolean).length); };
        ...
        _this.initialize = function () {
            var _a = _this.props, type = _a.type, layout = _a.layout, paint = _a.paint, layerOptions = _a.layerOptions, sourceId = _a.sourceId, before = _a.before;
            var map = _this.context.map;
