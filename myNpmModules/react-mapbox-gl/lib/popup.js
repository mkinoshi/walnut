...
var Popup = (function (_super) {
    ...
    Popup.prototype.render = function () {
        ...
        var className = classname_1.getClassName(defaultClassName.concat(anchorClass), this.props.className);
        return (React.createElement(projected_layer_1.default, __assign({ className: className }, props),
